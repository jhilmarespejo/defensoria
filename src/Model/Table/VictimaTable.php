 ...
 *
 * @method \App\Model\Entity\Victima get($primaryKey, $options = [])
 * @method \App\Model\Entity\Victima newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Victima[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Victima|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Victima|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Victima patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Victima[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\Victima findOrCreate($search, callable $callback = null, $options = [])
 */
class VictimaTable extends Table
{
