...
class PaginatorHelper extends Helper
{
    ...
    protected $_defaultConfig = [
        'options' => [],
        'templates' => [
            'nextActive' => '<li class="next"><a class="page-link" rel="next" href="{{url}}">{{text}}</a></li>',
            'nextDisabled' => '<li class="next disabled"><a class="page-link" href="" onclick="return false;">{{text}}</a></li>',
            'prevActive' => '<li class="prev"><a class="page-link" rel="prev" href="{{url}}">{{text}}</a></li>',
            'prevDisabled' => '<li class="prev disabled"><a class="page-link" href="" onclick="return false;">{{text}}</a></li>',
            ...
            'current' => '<li class="active"><a class="page-link" href="">{{text}}</a></li>',
